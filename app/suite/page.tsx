...
const tools = [
  ...
  {
    id: 'jd',
    name: 'Persona-JD Engine',
    tagline: 'Mission Blueprints',
    description: 'Generate compelling job descriptions with AI-powered talent density scoring.',
    ...
    stat: { label: 'JDs Generated', value: '890+' },
    span: '', // normal card
  },
  {
    id: 'flashcards',
  ...
  },
  {
    ...
    description: '3D job starfield. Salary predictions, skill demand heatmaps, and career trajectory.',
    ...
    span: '', // normal card — fills row 2 evenly
  },
  {
    id: 'search',
