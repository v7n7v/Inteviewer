/**
 * Hirely.ai AI Functions
 * Specialized AI functions for Hirely.ai features
...
export const hirelyAI = {
  ...
  analyzeResume: async (resumeText: string, jobDescription: string) => {
    ...
    const systemPrompt = `You are the Hirely.ai Liquid Resume Architect. Your goal is to transform a static CV into a high-density 'Mission Fit' document. 
...
Generate a professional, attractive job description that would attract high-density talent.`;
  ...
  chatInterview: async (messages: any[], currentTranscript: string) => {
    ...
    const systemPrompt = `You are the Shadow Interviewer at Hirely.ai. 
...
- Keep responses concise and actionable`;
  ...
  getMarketInsights: async (skills: string[]) => {
    ...
    const systemPrompt = `You are the Hirely.ai Market Oracle. Analyze skill sets and provide career intelligence.
