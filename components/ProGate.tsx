...
/**
 * ProGate — Blocks free-tier users from higher-limit pages/features.
 * Shows an upgrade wall with benefit highlights and a CTA to /suite/upgrade.
 * Usage: wrap higher-limit page content with <ProGate feature="Skill Bridge">...</ProGate>
 */
    ...
    <div className="flex-1 flex items-center justify-center px-6 py-16">
      ...
      >
        ...
        <p className="text-[var(--text-secondary)] text-sm mb-8 leading-relaxed">
          {description || `${feature} is available when you move beyond the free workspace limits.`}
        </p>
